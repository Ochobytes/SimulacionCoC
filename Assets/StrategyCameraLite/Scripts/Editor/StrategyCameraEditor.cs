...
public class StrategyCameraEditor : Editor
{
	...
	public override void OnInspectorGUI()
	{
		...
		if (SectionMovement)
		{
			...
			{
				EditorGUI.indentLevel++;
				EditorGUILayout.PropertyField(serializedObject.FindProperty("MinPositionMinZoom"));
				EditorGUILayout.PropertyField(serializedObject.FindProperty("MaxPositionMinZoom"));
                EditorGUILayout.PropertyField(serializedObject.FindProperty("MinPositionMaxZoom"));
                EditorGUILayout.PropertyField(serializedObject.FindProperty("MaxPositionMaxZoom"));
                EditorGUI.indentLevel--;
			}
		}
